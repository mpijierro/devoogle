            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                ...
                <tr>
                    <td width="1280" valign="top">
                        Hola, <br>a ocurrido una excepción al descargar el audio de <span class="title">{!! $resource->title() !!}</span>, en el siguiente enlace:<br>
                ...
                <tr>
                    <td width="1280" valign="top">
                        El mensaje de la excepción es: {!! $exception->getMessage() !!}<br>
                        Archivo: {!! $exception->getFile() !!}<br>
                        Línea: {!! $exception->getLine() !!}
                    </td>
                </tr>
                <tr>
                    <td><br>{!! $exception !!}<br></td>
                </tr>
                <tr>
                    <td width="1280" valign="top">
                        Vamos, espabila y revisa :p
                    </td>
                </tr>
